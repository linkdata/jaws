...
func (ui *UiInputDate) WriteHtmlInput(e *Element, w io.Writer, jid Jid, htmltype string, data ...interface{}) {
	val := ui.Get(e)
	if t, ok := val.(time.Time); ok {
		...
		writeUiDebug(e, w)
		ui.UiInput.WriteHtmlInput(w, e, htmltype, t.Format(ISO8601), data...)
		return
	}
