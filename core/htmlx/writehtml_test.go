...
func Test_WriteHTMLInner(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := htmlx.WriteHTMLInner(&sb, tt.args.jid, tt.args.tag, tt.args.typ, tt.args.inner, tt.args.attrs...); err != nil {
				t.Fatal(err)
			}
...
func Test_WriteHTMLSelect(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				jid:   2,
				val:   named.NewNamedBoolArray(false),
		...
		},
		{
			...
			args: args{
				jid: 3,
				val: func() (nba *named.NamedBoolArray) {
...
<option value="three">2</option>
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var sb strings.Builder
			if err := named.WriteHTMLSelect(&sb, tt.args.jid, tt.args.val, tt.args.attrs); err != nil {
				t.Fatal(err)
			}
			if got := sb.String(); got != tt.want {
				t.Errorf("HTMLSelect():\n got = %q\nwant = %q", got, tt.want)
...
func Test_WriteHTMLInput(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var sb strings.Builder
			if err := htmlx.WriteHTMLInput(&sb, tt.args.jid, tt.args.typ, tt.args.val, tt.args.attrs); err != nil {
				t.Fatal(err)
			}
			if got := sb.String(); got != tt.want {
