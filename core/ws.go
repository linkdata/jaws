...
func wsReader(ctx context.Context, ccf context.CancelCauseFunc, jawsDoneCh <-chan struct{}, incomingMsgCh chan<- wire.WsMsg, ws *websocket.Conn) {
...
func wsWriter(ctx context.Context, ccf context.CancelCauseFunc, jawsDoneCh <-chan struct{}, outboundMsgCh <-chan wire.WsMsg, ws *websocket.Conn) {
...
func wsWriteData(wc io.WriteCloser, firstMsg wire.WsMsg, outboundMsgCh <-chan wire.WsMsg) (err error) {
