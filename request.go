...
// Cache-Control directive. The lib/ui Handler sets it automatically. The
// metadata includes a one-use Request key; a copy replayed from an HTTP cache
// cannot establish another WebSocket connection.
