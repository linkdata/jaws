...
`jawsVar` and `JsCall` paths are application-controlled identifiers. The
browser rejects any dot-separated component that is exactly `__proto__`; put
user data in the JSON value, not the path.
