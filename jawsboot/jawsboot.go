...
func SetupUsing(jw *jaws.Jaws, version, cdn string) error {
	return jw.GenerateHeadHTML(
...
func Setup(jw *jaws.Jaws) error {
	return SetupUsing(jw, DefaultBootstrapVersion, DefaultBootstrapCDN)
}
